  ...
  render() {
    return (
      <Layout location={this.props.location}>
        ...
        <p>In the rare occasion you are wondering what my setup is, here it goes:</p>
        <ul>
          <li><b>OS:</b> Ubuntu (can't even navigate my way in Windows anymore).</li>
          <li><b>Main Computer:</b> <a href="https://amzn.to/36FqVbo">Dell G7 Series 7588</a>. Very fast, but heavy as hell.</li>
          <li><b>Auxiliary Computer:</b> <a href="https://amzn.to/35z8TXf">Samsumg Chromebook 3</a>. Very slow, but light as a feather.</li>
          <li><b>Text Editor:</b> VSCode.</li>
          <li><b>Communication:</b> Slack / Zoom.</li>
          <li><b>Prototyping:</b> Invision / Figma.</li>
          <li><b>Website:</b> Written in Gatsby, hosted in Netlify.</li>
        </ul>
        <TwitterButton />
        <Subscribe />
